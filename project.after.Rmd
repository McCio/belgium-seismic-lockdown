...
seasonplot(final.testing.24/sd(final.testing.24, na.rm = T), type="l", col=rainbow(7))
...
plot_grid(
  autoplot(ts(seasonbase.before.lockdown.24$figure, frequency=1)) + ylab("") + xlab("Hours") + scale_x_continuous() + geom_line(aes(col="Direct daily"), size=1.5) +
  ...
  autoplot(ts(seasonbase.before.lockdown.168$figure, frequency=1)) + ylab("") + xlab("Hours") + scale_x_continuous() + geom_line(aes(col="Direct weekly"), size=1.5) +
    geom_line(aes(y=season.before.lockdown.168$figure + rep(season.before.lockdown.24$figure, 7), col="Multi w+d")) +
    ...
    geom_line(aes(y=season.before.lockdown.168$figure, col="Multi weekly")) +
...
plot_grid(
  autoplot(ts(seasonbase.after.lockdown.24$figure, frequency=1)) + ylab("") + xlab("Hours") + scale_x_continuous() + geom_line(aes(col="Direct daily"), size=1.5) +
    geom_line(aes(y=season.after.lockdown.24$figure, col="Multi daily")) +
    scale_colour_manual("", values=c("purple", "yellow"), breaks=c("Direct daily", "Multi daily")),
  autoplot(ts(seasonbase.after.lockdown.168$figure, frequency=1)) + ylab("") + xlab("Hours") + scale_x_continuous() + geom_line(aes(col="Direct weekly"), size=1.5) +
    geom_line(aes(y=season.after.lockdown.168$figure + rep(season.after.lockdown.24$figure, 7), col="Multi w+d")) +
    ...
    geom_line(aes(y=season.after.lockdown.168$figure, col="Multi weekly")) +
    scale_colour_manual("", values=c("red", "purple", "blue", "yellow", "green"), breaks=c("Direct weekly", "Direct daily", "Multi" %s+% c(" weekly", " daily", " w+d"))),
  nrow = 2)
