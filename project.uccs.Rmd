...
for (model in to_test) {
  ...
  fit.name <- paste0("fit", paste0(model, collapse = ""))
  forecast.name <- paste0("forecast", paste0(model, collapse = ""))
  cat("SARIMA(", paste0(model[1:3], collapse = ","), ")(", paste0(model[4:6], collapse = ","), ")[", frequency(seis.h.train), "]\n", sep = "")
    ...
    print(plot_forecast(plotting.forecast) + autolayer(seis.h.test, series="Original"))
